...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
user.org:user:adc_to_udp_stream:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: adc_to_udp_stream_C, and set properties
  set adc_to_udp_stream_C [ create_bd_cell -type ip -vlnv user.org:user:adc_to_udp_stream:1.0 adc_to_udp_stream_C ]
  set_property -dict [ list \
   CONFIG.C_S00_AXI_BASEADDR {0x00000000} \
   CONFIG.C_S00_AXI_HIGHADDR {0x00000028} \
  ...
  # Create instance: adc_to_udp_stream_D, and set properties
  set adc_to_udp_stream_D [ create_bd_cell -type ip -vlnv user.org:user:adc_to_udp_stream:1.0 adc_to_udp_stream_D ]
  set_property -dict [ list \
   CONFIG.C_S00_AXI_BASEADDR {0x00000000} \
   CONFIG.C_S00_AXI_HIGHADDR {0x00000028} \
  ...
  # Create instance: axis_combiner_A, and set properties
  set axis_combiner_A [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 axis_combiner_A ]

  # Create instance: axis_combiner_B, and set properties
  set axis_combiner_B [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 axis_combiner_B ]

  # Create instance: axis_combiner_C, and set properties
  set axis_combiner_C [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 axis_combiner_C ]

  # Create instance: axis_combiner_D, and set properties
  set axis_combiner_D [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 axis_combiner_D ]
  ...
  # Create instance: axis_data_fifo_D, and set properties
  set axis_data_fifo_D [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_D ]
  set_property -dict [ list \
   CONFIG.FIFO_DEPTH {8192} \
   CONFIG.FIFO_MODE {2} \
   CONFIG.HAS_WR_DATA_COUNT {0} \
  ...
  # Create instance: axis_subset_converter_A, and set properties
  set axis_subset_converter_A [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_A ]
  set_property -dict [ list \
  ...
  # Create instance: axis_subset_converter_B, and set properties
  set axis_subset_converter_B [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_B ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {8} \
   CONFIG.S_TDATA_NUM_BYTES {8} \
   CONFIG.TDATA_REMAP {tdata[63:48], tdata[31:16], tdata[47:32], tdata[15:0]} \
  ...
  # Create instance: axis_subset_converter_C, and set properties
  set axis_subset_converter_C [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_C ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {8} \
   CONFIG.S_TDATA_NUM_BYTES {8} \
   CONFIG.TDATA_REMAP {tdata[63:48], tdata[31:16], tdata[47:32], tdata[15:0]} \
  ...
  # Create instance: axis_subset_converter_D, and set properties
  set axis_subset_converter_D [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_D ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {8} \
   CONFIG.S_TDATA_NUM_BYTES {8} \
   CONFIG.TDATA_REMAP {tdata[63:48], tdata[31:16], tdata[47:32], tdata[15:0]} \
  ...
  # Create instance: control_input_disable1, and set properties
  set control_input_disable1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 control_input_disable1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
  ...
  # Create instance: eth_tx_clk_reset, and set properties
  set eth_tx_clk_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 eth_tx_clk_reset ]
  ...
  # Create instance: qsfp_sel, and set properties
  set qsfp_sel [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 qsfp_sel ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $qsfp_sel
...
Port;FD4A0000;FD4AFFFF;0|FPD;DPDMA;FD4C0000;FD4CFFFF;0|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;800000000;0|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins adc_to_udp_stream_B/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins adc_to_udp_stream_A/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins fifo_controller/S_AXI_Lite] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins adc_to_udp_stream_C/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M09_AXI [get_bd_intf_pins adc_to_udp_stream_D/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M09_AXI]
  ...
  connect_bd_net -net rfdc_clk_dac0 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins dac_data_fifo/m_axis_aclk] [get_bd_pins fifo_controller/aclk] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins rfdc/clk_dac0] [get_bd_pins rfdc/s0_axis_aclk] [get_bd_pins rst_dac_153M6/slowest_sync_clk]
  ...
  connect_bd_net -net rst_307M3_peripheral_aresetn [get_bd_pins clk_wiz_1/resetn] [get_bd_pins fifo_controller/aresetn] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins rfdc/s0_axis_aresetn] [get_bd_pins rst_dac_153M6/peripheral_aresetn]
  ...
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins adc_to_udp_stream_A/s00_axi_aresetn] [get_bd_pins adc_to_udp_stream_B/s00_axi_aresetn] [get_bd_pins adc_to_udp_stream_C/s00_axi_aresetn] [get_bd_pins adc_to_udp_stream_D/s00_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rfdc/s_axi_aresetn] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0]
  ...
  connect_bd_net -net sw_1_1 [get_bd_ports led_1] [get_bd_ports sw_1]
  connect_bd_net -net sw_2_1 [get_bd_ports led_2] [get_bd_ports sw_2]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins adc_to_udp_stream_A/s00_axi_aclk] [get_bd_pins adc_to_udp_stream_B/s00_axi_aclk] [get_bd_pins adc_to_udp_stream_C/s00_axi_aclk] [get_bd_pins adc_to_udp_stream_D/s00_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins xxv_ethernet_0/dclk] [get_bd_pins xxv_ethernet_0/s_axi_aclk_0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
